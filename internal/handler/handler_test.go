...
func Test_testService_Ping(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()

	tests := []struct {
		name     string
		setup    func() (TestServiceHandler, http.ResponseWriter, *http.Request)
		validate func(w http.ResponseWriter)
	}{
		{
			name: "Success",
			setup: func() (TestServiceHandler, http.ResponseWriter, *http.Request) {
				mockLogic := mock.NewMockTestServiceLogicIer(mockCtrl)
...
func Test_testService_HealthCheck(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()

	tests := []struct {
		name        string
		setup       func() TestServiceHandler
		wantSvcName string
		wantMsg     string
		wantStat    bool
	}{

...
//go:generate mockgen --build_flags=--mod=mod --destination=./../../pkg/mock/mock_common.go --package=mock github.com/PereRohit/test-service/internal/handler Commoner,HealthChecker
